...
![HomeLens landing page with a living-room model, confidence badges, and a Scan Rescue prompt](docs/screenshots/home.png)

![Simulated room capture with live guidance and a ceiling-height measurement flagged for review](docs/screenshots/scan.png)

![Analysis page showing decision stability, Scan Rescue, calibration, and the verification queue](docs/screenshots/analysis.png)
